  ...
  $(window).on("load", function () {
    ...
    if ($(".main-header li.dropdown ul").length) {
      $(".main-header li.dropdown").append(
        '<div class="dropdown-btn"><i class="fa-solid fa-angle-down"></i></div>'
      );
      ...
      $(".about-sidebar .close-button").on("click", function () {
        $(".about-sidebar").removeClass("active");
      });

      $(".about-sidebar .gradient-layer").on("click", function () {
        $(".about-sidebar").removeClass("active");
      });

      $(".xs-sidebar-group .close-button").on("click", function () {
    ...
    //   var totalSlides2 = $(
    //     ".project-one__swiper-carousel .swiper-slide"
    //   ).length;
    ...
    const serviceImgItemTwo = document.querySelectorAll(
    ...
    serviceImgItemTwo.forEach((item) => {
      item.addEventListener("mousemove", (event) => {
